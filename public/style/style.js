...
export const authLayoutStyles = {
  ...
  logoImg: "rounded-xl shadow-lg shadow-emerald-500/25",
  ...
  mobileLogoImg: "rounded-xl shadow-md shadow-emerald-500/20",
...
export const layoutStyles = {
  ...
  logoImg: "rounded-lg shadow-lg shadow-emerald-500/30 transition-transform group-hover:scale-105",
